...
/// Smoke tests that verify all View structs can be instantiated with representative data
...
final class ViewSmokeTests: XCTestCase {
    ...
    func testSuggestedPromptsViewCapturesPrompts() {
        ...
        var selected = ""
        let view = SuggestedPromptsView(prompts: prompts, isLoading: false, onSelect: { selected = $0 })
