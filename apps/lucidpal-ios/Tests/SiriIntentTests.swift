...
final class SiriIntentTests: XCTestCase {
    ...
    func testAskLucidPalIntentStoresQuery() async throws {
        var intent = AskLucidPalIntent()
    ...
    func testAskLucidPalIntentTrimsWhitespace() async throws {
        var intent = AskLucidPalIntent()
    ...
    func testAskLucidPalIntentThrowsOnEmptyQuery() async {
        var intent = AskLucidPalIntent()
        intent.query = "   "
        do {
            _ = try await intent.perform()
