...
final class SnapshotTests: XCTestCase {
    ...
    // Snapshots are written to /tmp/lucidpal-snapshots/__Snapshots__/SnapshotTests/
    private static let snapshotFile: StaticString = "/tmp/lucidpal-snapshots/SnapshotTests.swift"
