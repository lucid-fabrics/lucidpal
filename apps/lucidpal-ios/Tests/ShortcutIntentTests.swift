...
final class ShortcutIntentTests: XCTestCase {
    ...
    // MARK: - AskLucidPalShortcutIntent

    func testAskLucidPalShortcutIntentStoresQuery() async throws {
        var intent = AskLucidPalShortcutIntent()
    ...
    func testAskLucidPalShortcutIntentTrimsQuery() async throws {
        var intent = AskLucidPalShortcutIntent()
    ...
    func testAskLucidPalShortcutIntentValidatesEmptyQuery() async throws {
        var intent = AskLucidPalShortcutIntent()
        intent.query = "   "
