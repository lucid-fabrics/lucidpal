...
private let llmLogger = Logger(subsystem: "app.lucidpal", category: "LLM")
...
final class ChatViewModel: ObservableObject {
    ...
    /// Navigation title — equals session title in session mode, "LucidPal" otherwise.
    ...
    init(
        ...
        self.sessionTitle = session?.title ?? "LucidPal"
