...
struct WebSearchSettingsView: View {
    ...
    private var enableSection: some View {
        Section {
            ...
            Text("When enabled, LucidPal can search the web to answer questions about current events and real-time data.")
        }
    }
    ...
    private var jsonInfoSheet: some View {
        NavigationStack {
            Form {
                Section {
                    Text("SearXNG disables JSON output by default. You must enable it in your instance's settings.yml before LucidPal can fetch results.")
                } header: {
