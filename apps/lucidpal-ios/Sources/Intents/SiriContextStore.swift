...
private let contextStoreLogger = Logger(subsystem: "app.lucidpal", category: "SiriContextStore")

/// Snapshot of the most recent calendar action taken in LucidPal — in-app or via Siri.
