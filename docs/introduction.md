...
| **Gmail**                     | Connect your Gmail account to let the AI read email subjects, senders, and snippets on-device. Full bodies are never fetched. See the [Gmail guide](./guides/gmail). |
